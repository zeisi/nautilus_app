...
public interface zzai extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzai {
        ...
        private static class C0019zza implements zzai {
        ...
        public static zzai zzcN(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzai)) ? new C0019zza(iBinder) : (zzai) queryLocalInterface;
        }
