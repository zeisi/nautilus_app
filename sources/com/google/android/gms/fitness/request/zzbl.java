...
public class zzbl implements Parcelable.Creator<zzbk> {
    static void zza(zzbk zzbk, Parcel parcel, int i) {
        int zzaZ = zzc.zzaZ(parcel);
        zzc.zza(parcel, 1, zzbk.zzDl(), false);
        zzc.zza(parcel, 2, zzbk.getCallbackBinder(), false);
        zzc.zzc(parcel, 1000, zzbk.getVersionCode());
        zzc.zzJ(parcel, zzaZ);
    }
