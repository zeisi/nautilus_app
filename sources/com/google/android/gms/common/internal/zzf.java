...
public abstract class zzf<T extends IInterface> {
    ...
    protected class zzi implements C0002zzf {
        public zzi() {
        }
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (this.zzaFc > 0) {
            ...
            append.println(new StringBuilder(String.valueOf(valueOf).length() + 21).append(j).append(Constants.EMPTY_SPACE).append(valueOf).toString());
        }
        if (this.zzaFb > 0) {
            ...
            append2.println(new StringBuilder(String.valueOf(valueOf2).length() + 21).append(j2).append(Constants.EMPTY_SPACE).append(valueOf2).toString());
        }
        if (this.zzaFe > 0) {
            ...
            append3.println(new StringBuilder(String.valueOf(valueOf3).length() + 21).append(j3).append(Constants.EMPTY_SPACE).append(valueOf3).toString());
        }
    }
    ...
    public void zza(@NonNull C0002zzf zzf) {
        this.zzaFi = (C0002zzf) zzac.zzb(zzf, (Object) "Connection progress callbacks cannot be null.");
        zza(2, (IInterface) null);
    }

    public void zza(@NonNull C0002zzf zzf, int i, @Nullable PendingIntent pendingIntent) {
        this.zzaFi = (C0002zzf) zzac.zzb(zzf, (Object) "Connection progress callbacks cannot be null.");
    ...
    public void zzxz() {
        ...
        if (isGooglePlayServicesAvailable != 0) {
            zza(1, (IInterface) null);
            zza((C0002zzf) new zzi(), isGooglePlayServicesAvailable, (PendingIntent) null);
            return;
        }
        zza((C0002zzf) new zzi());
    }
}
