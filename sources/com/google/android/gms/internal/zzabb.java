...
public interface zzabb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzabb {
        ...
        private static class C0023zza implements zzabb {
        ...
        public static zzabb zzbp(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzabb)) ? new C0023zza(iBinder) : (zzabb) queryLocalInterface;
        }
