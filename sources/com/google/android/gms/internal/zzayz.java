...
public class zzayz extends com.google.android.gms.common.internal.safeparcel.zza implements Comparable<zzayz> {
    ...
    public static class zza implements Comparator<zzayz> {
        ...
        public int compare(zzayz zzayz, zzayz zzayz2) {
            return zzayz.zzbBJ == zzayz2.zzbBJ ? zzayz.name.compareTo(zzayz2.name) : zzayz.zzbBJ - zzayz2.zzbBJ;
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!zzaa.equal(this.name, zzayz.name) || this.zzbBI != zzayz.zzbBI || this.zzbBJ != zzayz.zzbBJ) {
            return false;
        }
        switch (this.zzbBI) {
            case 1:
