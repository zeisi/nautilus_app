...
public interface zzbaq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzbaq {
        ...
        private static class C0058zza implements zzbaq {
        ...
        public static zzbaq zzff(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzbaq)) ? new C0058zza(iBinder) : (zzbaq) queryLocalInterface;
        }
