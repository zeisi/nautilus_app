...
public interface zzacl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzacl {
        ...
        private static class C0026zza implements zzacl {
        ...
        public static zzacl zzbB(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzacl)) ? new C0026zza(iBinder) : (zzacl) queryLocalInterface;
        }
