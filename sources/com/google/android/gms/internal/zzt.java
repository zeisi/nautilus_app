...
public class zzt {
    ...
    static class zza {
        ...
        private final List<C0060zza> zzak = new ArrayList();
        ...
        private static class C0060zza {
            public final String name;
            public final long time;
            public final long zzam;

            public C0060zza(String str, long j, long j2) {
                this.name = str;
                this.zzam = j;
                this.time = j2;
            }
        ...
        public synchronized void zza(String str, long j) {
            ...
            this.zzak.add(new C0060zza(str, j, SystemClock.elapsedRealtime()));
        }
        ...
        public synchronized void zzd(String str) {
            ...
            if (totalDuration > 0) {
                ...
                long j2 = j;
                for (C0060zza next : this.zzak) {
                    long j3 = next.time;
                    zzt.zzb("(+%-4d) [%2d] %s", Long.valueOf(j3 - j2), Long.valueOf(next.zzam), next.name);
                    j2 = j3;
                }
            }
        }
