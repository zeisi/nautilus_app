...
public class zzaaa extends zzaae {
    ...
    public void onStart() {
        ...
        Log.d("AutoManageHelper", new StringBuilder(String.valueOf(valueOf).length() + 14).append("onStart ").append(z).append(Constants.EMPTY_SPACE).append(valueOf).toString());
        if (!this.zzazZ) {
            int i = 0;
            while (true) {
                int i2 = i;
    ...
    public void zza(int i, GoogleApiClient googleApiClient, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        Log.d("AutoManageHelper", new StringBuilder(54).append("starting AutoManage for client ").append(i).append(Constants.EMPTY_SPACE).append(this.mStarted).append(Constants.EMPTY_SPACE).append(this.zzazZ).toString());
