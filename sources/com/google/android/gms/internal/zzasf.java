...
public interface zzasf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzasf {
        ...
        private static class C0056zza implements zzasf {
        ...
        public static zzasf zzdj(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzasf)) ? new C0056zza(iBinder) : (zzasf) queryLocalInterface;
        }
