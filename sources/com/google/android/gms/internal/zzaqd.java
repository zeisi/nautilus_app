...
public interface zzaqd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaqd {
        ...
        private static class C0052zza implements zzaqd {
        ...
        public static zzaqd asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaqd)) ? new C0052zza(iBinder) : (zzaqd) queryLocalInterface;
        }
