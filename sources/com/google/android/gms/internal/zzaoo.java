...
public interface zzaoo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaoo {
        ...
        private static class C0031zza implements zzaoo {
        ...
        public static zzaoo zzcs(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaoo)) ? new C0031zza(iBinder) : (zzaoo) queryLocalInterface;
        }
