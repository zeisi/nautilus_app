...
public interface zzaoq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaoq {
        ...
        private static class C0033zza implements zzaoq {
        ...
        public static zzaoq zzcu(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaoq)) ? new C0033zza(iBinder) : (zzaoq) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(parcel.readInt() != 0 ? zzl.CREATOR.createFromParcel(parcel) : null);
                    return true;
                case 1598968902:
