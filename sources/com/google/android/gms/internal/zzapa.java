...
public interface zzapa extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzapa {
        ...
        private static class C0043zza implements zzapa {
        ...
        public static zzapa zzcE(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzapa)) ? new C0043zza(iBinder) : (zzapa) queryLocalInterface;
        }
