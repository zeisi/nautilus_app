...
public interface zzack extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzack {
        ...
        private static class C0025zza implements zzack {
        ...
        public static zzack zzbA(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzack)) ? new C0025zza(iBinder) : (zzack) queryLocalInterface;
        }
