...
public interface zzapt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzapt {
        ...
        private static class C0051zza implements zzapt {
        ...
        public static zzapt zzcM(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzapt)) ? new C0051zza(iBinder) : (zzapt) queryLocalInterface;
        }
