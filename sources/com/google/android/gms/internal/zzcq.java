...
public interface zzcq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcq {
        ...
        private static class C0059zza implements zzcq {
        ...
        public static zzcq zzf(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzcq)) ? new C0059zza(iBinder) : (zzcq) queryLocalInterface;
        }
