package com.nautilus.omni.customviews.slidingtabs;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private Typeface mLatoRegularTypeface;
    /* access modifiers changed from: private */
    public final SlidingTabStrip mTabStrip;
    private int mTabViewLayoutId;
    private int mTabViewTextViewId;
    private int mTabsTextColor;
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mTabsTextColor = 0;
        setHorizontalScrollBarEnabled(false);
        setFillViewport(true);
        this.mTitleOffset = (int) (24.0f * getResources().getDisplayMetrics().density);
        this.mTabStrip = new SlidingTabStrip(context);
        this.mLatoRegularTypeface = Typeface.createFromAsset(context.getAssets(), "fonts/Lato-Regular.ttf");
    ...
    public void setmTabsTextColor(int mTabsTextColor2) {
        this.mTabsTextColor = mTabsTextColor2;
    }
    ...
    public TextView createDefaultTabView(Context context) {
        ...
        textView.setTypeface(this.mLatoRegularTypeface);
        if (this.mTabsTextColor != 0) {
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            String desc = this.mContentDescriptions.get(i, (Object) null);
            if (desc != null) {
