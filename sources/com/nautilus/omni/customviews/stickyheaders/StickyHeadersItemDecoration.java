...
public class StickyHeadersItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private class AdapterDataObserver extends RecyclerView.AdapterDataObserver {
        ...
        public void onItemRangeMoved(int fromPosition, int toPosition, int itemCount) {
            StickyHeadersItemDecoration.this.headerStore.onItemRangeMoved(fromPosition, toPosition, itemCount);
        }

        public void onItemRangeChanged(int positionStart, int itemCount) {
            StickyHeadersItemDecoration.this.headerStore.onItemRangeChanged(positionStart, itemCount);
        }
    }
}
