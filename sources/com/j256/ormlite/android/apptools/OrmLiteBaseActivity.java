...
public abstract class OrmLiteBaseActivity<H extends OrmLiteSqliteOpenHelper> extends Activity {
    ...
    public H getHelperInternal(Context context) {
        H newHelper = OpenHelperManager.getHelper(context);
        logger.trace("{}: got new helper {} from OpenHelperManager", (Object) this, (Object) newHelper);
        return newHelper;
    }
    ...
    public void releaseHelper(H helper2) {
        ...
        logger.trace("{}: helper {} was released, set to null", (Object) this, (Object) helper2);
        this.helper = null;
    }
