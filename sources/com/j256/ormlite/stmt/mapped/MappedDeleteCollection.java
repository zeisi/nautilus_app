...
public class MappedDeleteCollection<T, ID> extends BaseMappedStatement<T, ID> {
    ...
    private static <T, ID> int updateRows(DatabaseConnection databaseConnection, Class<T> clazz, MappedDeleteCollection<T, ID> deleteCollection, Object[] args, ObjectCache objectCache) throws SQLException {
        try {
            ...
            logger.debug("delete-collection with statement '{}' and {} args, changed {} rows", (Object) deleteCollection.statement, (Object) Integer.valueOf(args.length), (Object) Integer.valueOf(rowC));
            if (args.length > 0) {
